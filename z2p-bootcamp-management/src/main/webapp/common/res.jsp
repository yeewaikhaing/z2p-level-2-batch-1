...
<c:url var="faJs" value="/webjars/font-awesome/6.1.0/css/fontawesome.css"></c:url>
...
<c:url var="popperJs" value="/webjars/bootstrap/5.1.3/js/bootstrap.bundle.min.js"></c:url>
